/* clarity-js v0.7.8: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get queue() {
    ...
    function F() {
        ...
        L = {
            gap: t - P
        }, ar(25), L.gap < 3e5 ? B = q(F, U) : Qr && (A("clarity", "suspend"), mi(), ["mousemove", "touchstart"].forEach((function(t) {
    ...
    function et(t) {
        ei() && o.lean && (o.lean = !1, tt = {
            key: t
        }, Sr(), o.upgrade && o.upgrade(t), ar(3))
    }
    ...
    function Ia(t) {
        return void 0 === t && (t = !1), at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return Sa = null, (e = !1 === o.lean && xa > 0 && (xa < 1048576 || Ar.sequence > 0)) && Y(1, 1), Re(),
                            function() {
                                var t = [];
                                va = [];
    ...
    function Za() {
        try {
            for (var t in Ua) {
                ...
                for (var a in n) {
                    var r = parseInt(a),
                        i = (h = er(Ga(n[r]))) ? JSON.stringify(h).substring(0, 1e4) : h;
                    i && Qa(e, r, i)
                }
                var o = Ba[e];
                for (var u in o) {
    ...
    function er(t, e) {
        ...
        if (e && e[a.name]) {
            var r = e[a.name];
            if (1 !== a.type && nr(r, a.condition)) n = er(t, r);
            ...
            try {
                if (null === br) {
                    for (var u = location.hostname ? location.hostname.split(".") : [], c = u.length - 1; c >= 0; c--)
                        if (br = ".".concat(u[c]).concat(br || ""), c < u.length - 1 && (document.cookie = "".concat(i).concat(";").concat("domain=").concat(br), Dr(t) === e)) return;
                    br = ""
                }
            } catch (t) {
                br = ""
    ...
    function Xr(t, e, n, a) {
        void 0 === a && (a = !1), n = Yr(n);
        try {
            t[u("addEventListener")](e, n, a), qr.push({
                event: e,
                target: t,
                listener: n,
                capture: a
    ...
    var oi = Object.freeze({
        ...
        hashText: Kt,
        start: function() {
            Oe(), xe(), qe(), Ae = null, Ie = new WeakMap, De = {}, Ce = [], je = !!window.IntersectionObserver, Xt(),
                function() {
        ...
        stop: function() {
            qe(), Ie = null, De = {}, Ce = [], Ae && (Ae.disconnect(), Ae = null), je = !1, Pt(),
                function() {
