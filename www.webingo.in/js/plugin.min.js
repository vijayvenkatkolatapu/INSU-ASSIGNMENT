...
function _typeof(n) {
    ...
    var i, hn = (/iPad|iPhone|iPod/.test(navigator.userAgent) || !!navigator.platform && /iPad|iPhone|iPod/.test(navigator.platform)) && !rn.MSStream,
        ...
        e = function(n, e, t) {
            console.warn("%cHC Off-canvas Nav:%c " + t + "%c '" + n + "'%c is now deprecated and will be removed in the future. Use%c '" + e + "'%c option instead. See details about plugin usage at https://github.com/somewebmedia/hc-offcanvas-nav.", "color: #fa253b", "color: default", "color: #5595c6", "color: default", "color: #5595c6", "color: default")
        },
        Mn = 0;
    sn.fn.extend({
        hcOffcanvasNav: function() {
            ...
            return this.each(function() {
                ...
                if (e.find("ul").addBack("ul").length) {
                    var n, o, i, c, a, t, r, l, y = "hc-nav-".concat(++Mn),
                        s = (n = "hc-offcanvas-".concat(Mn, "-style"), o = sn('<style id="'.concat(n, '">')).appendTo(sn("head")), i = {}, c = {}, a = function(n) {
                    ...
                    var N = function(n, e, t) {
                        ...
                        j = function(n) {
                            ...
                            var i = v.hasClass(cn),
                                c = ["hc-offcanvas-nav", an.navClass || "", y, an.navClass || "", "nav-levels-" + an.levelOpen || "none", "nav-position-" + an.position, an.disableBody ? "disable-body" : "", hn ? "is-ios" : "", mn ? "touch-device" : "", i ? cn : "", an.rtl ? "rtl" : ""].join(" ");
                ...
                function nn(n, e) {
                    for (var t = n; t <= Object.keys(w).length; t++)
                        ...
                        else if (0 !== n || an.closeOpenLevels)
                        for (var a = 0; a < w[t]; a++) U(t, a, t == n);
                    M && (N(null, n - 1), M = !1)
                }
            })
        }
